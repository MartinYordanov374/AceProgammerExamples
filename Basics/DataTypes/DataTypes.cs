...
{ 
    class Program
    {
        ...
        {
            var FirstExampleVar = "string"; // тук променливата ще приеме тип string, защото след равното ( оператор за присвояване ) имаме string (текст);
            ...
            char FirstExampleChar = 'a'; // char винаги са между две единични кавички.
            double SecondExampleChar = ''; // Не е забранено да имаме празен char.

            // тук променливите ще приемат тип bool, защото сме ги дефинирали като такива.
            char FirstExampleBool = true; // bool винаги e или true или false
